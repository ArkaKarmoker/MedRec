...
urlpatterns = [
    ...
    path("api/sessions/<int:session_id>/pin/", views.toggle_pin_session, name="toggle_pin_session"),
    path("api/sessions/<int:session_id>/share/", views.share_session, name="share_session"),
